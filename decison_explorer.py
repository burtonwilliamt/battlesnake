...
class DebugSnakeDecision(multi_max.DecisionNode):
    ...
    def __init__(
        self, *, snk_id: int, moves: Mapping[models.Direction, multi_max.DecisionNode]
    ):
...
class DecisionExplorer:
    ...
    def display_snake_decision(
        self, node: multi_max.SnakeDecision, choice: models.Direction = None
    ):
        # State label
        self.stdscr.addstr(
