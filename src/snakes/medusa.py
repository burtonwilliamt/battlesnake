...
class Plan:
    ...
    def next(self) -> models.Direction:
    ...
    def next(self, data: models.Data) -> models.Move:
        ...
        if self.mode == LoopMode.right:
            ...
            if board.can_move(snk, models.DOWN):
                ...
                self.mode = LoopMode.up
                return models.RIGHT
            elif board.can_move(snk, models.LEFT):
                self.mode = LoopMode.up
                return models.LEFT
...
class LoopPlan(Plan):
    ...
    # If you can't move left, move down, repeat
    # If you can't move up, move right
    def next(self, data: models.Data) -> models.Direction:
        snk = data.you
        board = data.board
        if self.mode == LoopMode.priming:
            if snk.head.x > self.left_column:
...
class SmartSnake:
    ...
    def move(self, data: models.Data) -> models.Direction:
        pass
